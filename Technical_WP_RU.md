...
PostgreSQL - сервис с состоянием, реплицируется на две и более реплики в каждом регионе. Реплики обслуживают запросы, требующие исключительно 
доступа на чтение базы данных. Также, одна из реплик является standby-мастером. С одной из реплик производится регулярное 
