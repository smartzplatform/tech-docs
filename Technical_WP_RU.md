...
Описанная в разделе "События" механика также является отличной базой для интеграции с сервисом [IFTTT](https://ifttt.com).
...
определит триггеры для событий смарт-контрактов. Аргументы событий будут представлены в виде полей триггеров, чтобы
