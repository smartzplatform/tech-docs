...
масштабированы. Ярким примером сервиса с состоянием является база данных. Сервис с состоянием требует дополнительных
...
Если в конкретном случае не оговорено иное, не производится разбиение кластера (шардинг) между регионами - задержка 
