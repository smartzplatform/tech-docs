...
Алгыc Иевлев, Алексей Макеев, Вячеслав Мельников, Сергей Прилуцкий, Владимир Храмов.
...
В простом варианте пользовательский интерфейс экземпляра контракта генерируется автоматически на основе программного
...
2. На этапе сборки DApp контролируется целостность всех зависимостей с помощью npm-механизма 
...
размещены на серверах Smartz и доступны в DApp по соотв. пути, начинающемуся со `/static/`.


раздел про выдачу локального даппа
    про публикацию package-lock и исходников
